...
import os
from unit_converter import transform

def save(data_origin, direc='./data/', data_file='data.fits', data_file_mean='mean.fits'):
    """
    ...
    for i in data_origin:
        #Check units
        factor = transform[fits.open(i)[1].header['TUNIT1']]
